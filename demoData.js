...
exports.simulatePoolChanges = exports.getRandomDemoPools = exports.DEMO_POOLS = void 0;
/**
 ...
 */
function getRandomDemoPools(count = 3) {
    const shuffled = [...exports.DEMO_POOLS].sort(() => 0.5 - Math.random());
    return shuffled.slice(0, Math.min(count, exports.DEMO_POOLS.length));
}
exports.getRandomDemoPools = getRandomDemoPools;
/**
 * Simulate pool performance changes over time
 */
function simulatePoolChanges(pool) {
    const updatedPool = Object.assign({}, pool);
...
exports.simulatePoolChanges = simulatePoolChanges;
